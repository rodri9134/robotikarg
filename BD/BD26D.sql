...
INSERT INTO `articulos` (`id`, `titulo`, `descripcion`, `referencia`, `precio`, `imagen`, `idCategoria`, `idTienda`) VALUES
	...
	(3, 'Holam undafdsdodf', '324', 'dsfsdfas', 23423, 'makeblock.jpg', 1, 1);
...
-- Volcando datos para la tabla proyecto.instrucciones: ~4 rows (aproximadamente)
...
-- Volcando datos para la tabla proyecto.instrucciones_usuarios: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla proyecto.lenguajes: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla proyecto.tiendas: ~8 rows (aproximadamente)
DELETE FROM `tiendas`;
...
INSERT INTO `torneos` (`id`, `imagen`, `nombre`, `fecha`, `ubicacion`, `enlace`, `pagina`, `costeEquipo`, `idprovincia`, `idrangoedad`) VALUES
	(2, 'roborave.jpg', 'RoboRave Ibérica', '2021-05-05 13:00:00', 'Toledo', 'https://goo.gl/maps/SwaiaQFa7gMQmZEQ7', 'http://roboraveiberica.org/', ' 23 €', 15, 5),
...
INSERT INTO `usuarios` (`id`, `email`, `password`, `telefono`, `foto`, `idrol`) VALUES
	(17, 'rodri9134@gmail.com', '$2y$10$4CrvqrCmJQqTsZCIkXG0duYQX2fRJA0rQIdv9RAM4tT.vu/zTJQwK ', '123456789', NULL, 1),
	(19, 'r@r.com', '$2y$10$CjSo3LUUz1WrIX9cMKBv.e.uFNVWAxrxyLXom4k5iW/H0o8pRaWca ', '123456789', NULL, 1),
	(21, 'prueba@prueba.com', '$2y$10$XcmdmOlYsZhwF29Nw8y/xep6SHTgwL8oP7Wok476fRbF6kDfoTwHa ', '123456789', NULL, 1),
	(22, 'adminrob@gmail.com', '$2y$10$dfmSrg4RUW6mNHG9fFS8s.mZN9ub1bsN4jBHoNGWWief3peQ8zBOu', NULL, NULL, 2);
